...
[![CI](https://github.com/alyonalar/document-intelligence-platform/actions/workflows/ci.yml/badge.svg)](https://github.com/alyonalar/document-intelligence-platform/actions/workflows/ci.yml)
...
I built this project for my own use: I wanted one private place where I could work with TXT, Markdown, DOCX, PDF, and scanned documents without making a cloud AI provider mandatory. The repository documents the resulting backend architecture, data-integrity rules, testing strategy, failure handling, and product trade-offs.

> **Scope:** independently designed and developed personal project. It is not a production SaaS or a legal-grade document analysis tool.

Part of my [Engineering Portfolio](https://github.com/alyonalar/engineering-portfolio).
...
The project is actively evolving and is published for technical review.
